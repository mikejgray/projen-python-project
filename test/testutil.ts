...
//
// This module contains which is more or less copied from Projen project, since it is useful for testing
// but not exposed outside of Projen itself.
//

export function mkdtemp() {
  return fs.mkdtempSync(path.join(os.tmpdir(), 'awscdk-app-templates-test-'));
}
